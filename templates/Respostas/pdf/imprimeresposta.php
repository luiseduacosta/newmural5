...
<div class="container mt-4">
    <div class="card">
        <div class="card-body" style="font-size: 12px;">
            ...
            <p><strong>Professor(a):</strong> <?= $resposta->estagiario->professor->nome ?></p>
        </div>
    </div>
</div>
...
<table class="table" style="width: 100%; background-color: white;">
    <tr>
        ...
        <td style="width: 33%"><span style="font-size: 100%; text-decoration: overline"><?= $resposta->estagiario->aluno->nome ?></span></td>
        <td style="width: 33%"><span style="font-size: 100%; text-decoration: overline"><?= $resposta->estagiario->supervisor->nome ?></span></td>
    </tr>

    <tr>
        <td style="width: 33%"></td>
        <td style="width: 33%"><span style="font-size: 100%">DRE: <?= $resposta->estagiario->aluno->registro ?></span></td>
        <td style="width: 33%"><span style="font-size: 100%">CRESS <?= $resposta->estagiario->supervisor->cress ?></span></td>
    </tr>
</table>