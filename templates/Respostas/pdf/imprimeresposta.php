...
<h2 style="text-align:center; line-height: 80%; margin: 0">
    ...
    <br />
    <span style="font-size: 100%">Avaliação do estagiário(a) <?= $resposta->estagiario->aluno->nome ?></span>
    <br />
</h2>
...
<div class="container mt-4">
   ...
   <p style="text-align:right; line-height:100%;">
        ...
        Rio de Janeiro, <?= $today->i18nFormat("dd ' de ' MMMM ' de ' yyyy"); ?>
    </p>
    ...
    <table class="table" style="width: 100%; background-color: white;">
        <tr>
            ...
            <td style="width: 33%"><span style="font-size: 100%; text-decoration: overline"><?= $resposta->supervisora->nome ? $resposta->supervisora->nome : '' ?></span></td>
        </tr>
